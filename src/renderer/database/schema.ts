import { zOperation } from "@common/types/operation";
import { z } from "zod";
...
// against it. (The operation shapes come from zOperation, which is
// itself the source of truth for the Operation types.)
